...
import com.example.filmyapp.databinding.CastCrewFragmentBinding
...
class CastCrewFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(
            ...
            args.putString(MoviesFragment.MOVIE_ID, movieId)
            args.putString(MoviesFragment.MOVIE_TITLE, movieTitle)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        movieId = arguments?.getString(MoviesFragment.MOVIE_ID)
        movieTitle = arguments?.getString(MoviesFragment.MOVIE_TITLE)
